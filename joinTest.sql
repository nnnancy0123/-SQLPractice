...
CREATE TABLE pairings (
  id bigint NOT NULL,
  kickoff Date,
  my_country_id bigint,
  enemy_country_id bigint
) ;

CREATE TABLE goals_tmp (
  my_country  character varying(64),
  enemy_country  character varying(64),
  goal_time  character varying(10),
